...
REQUIRED_MARKERS = {
    '.agent/reports/understanding-proof.md': ['## Files Read', '## End-to-End Understanding', '## Next Phase Justification'],
    '.agent/reports/session-intake.md': ['## Startup Checklist', '## Required Reading Evidence'],
    '.agent/reports/master-blueprint.md': ['## Mission', '## Architecture', '## Delivery Plan'],
}
